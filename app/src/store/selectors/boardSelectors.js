...
export const getSettings = state => state.board.settings;
export const getConfirmationStatus = state => state.board.isConfirmVisible;
export const getPublicIp = state => state.board.publicIp;
